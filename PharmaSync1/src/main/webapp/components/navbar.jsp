<%@page import="com.in.PharmaSync1.entities.User"%>
<%
	User user1 = (User) session.getAttribute("current-user");
%>
<nav class="navbar navbar-expand-lg navbar-dark custom-bg">
	<div class="container">
		<a class="navbar-brand" href="./index.jsp"><img src="./img/PharmaSyncLogo.jpg" alt="PharmaSync" height="50px" width="350px"></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link"
					href="./home.jsp">Home page<span class="sr-only">(current)</span>
				</a></li>
